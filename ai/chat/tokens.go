...
// CountTokensApprox estimates the token count for a slice of messages using the 4-chars≈1-token heuristic. Use when a provider's native tokenizer is unavailable.
