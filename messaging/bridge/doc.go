// Package bridge provides provider adapters that connect messaging primitives
// (Producer, Consumer) to the gokit provider pattern.
//
...
//
// Once messaging components are expressed as providers, they compose naturally
// with all other kit patterns that accept providers:
//
