...
// CircuitBreakerConfig configures the circuit breaker middleware for
// message handlers. It maps directly to resilience.CircuitBreakerConfig.
type CircuitBreakerConfig struct {
	...
	// HalfOpenMax is the maximum number of probe requests allowed in half-open state.
	// Default: 2.
	HalfOpenMax int
...
// CircuitBreakerHandler wraps a MessageHandler with circuit breaker logic
// powered by resilience.CircuitBreaker. When the circuit is open,
// messages are rejected immediately with resilience.ErrCircuitOpen.
