...
// PausableConsumer is an optional capability for transports that can pause and resume delivery.
// Core consumers are not required to implement it; callers should check support explicitly.
...
// Backends that do not implement it reject rebalance semantics at configuration time or omit this interface.
