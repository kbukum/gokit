...
// Register installs the Kubernetes provider into the supplied workload factory registry. Call this once at application startup before invoking [workload.New]. Returns an error if the provider name is already registered.
