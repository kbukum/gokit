...
// ParseMemory converts human-readable memory strings to bytes. Supported suffixes: k/ki (KiB),
// m/mi (MiB), g/gi (GiB), t/ti (TiB). Without suffix, the value is treated as bytes.
...
// ParseCPU converts human-readable CPU strings to nanocores. Supported formats: "0.5" (cores),
// "500m" (millicores), "1" (1 core).
