...
// Checker is the lightweight authorization interface. Group 05 canonical RBAC + ABAC evaluation is implemented by Engine; Checker remains useful for simple boolean permission gates.
//
...
// MapChecker is a simple in-memory Checker backed by a map of subject → permission patterns. Supports wildcard matching via MatchPattern and defaults to deny when no subject or permission pattern matches.
