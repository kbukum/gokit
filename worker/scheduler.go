...
// Scheduler is a Component that manages multiple periodic jobs.
// Each job runs in its own goroutine via an internal TickerWorker, giving independent intervals,
// health, and non-overlap guarantees.
//
...
// Start launches all jobs. If any job fails to start, previously started jobs are stopped
