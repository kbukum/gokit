...
//
// It is intentionally lower-level than chat completions: adapters target Triton,
// KServe v2, vLLM raw generation, TGI, BentoML, ONNX Runtime Server,
// TFServing, and custom REST/gRPC model servers. Conversational LLM APIs live in
// the llm module; inference carries named inputs/outputs, tensors, bytes, text,
// JSON pass-through values, serving-runtime descriptors, and explicit adapter
// registration.
//
