...
// Validator is the pluggable per-item validation seam the collector applies
// before an item is published. It is generic over the item type so validation
// is not pinned to any concrete family; a nil Validator accepts every item.
