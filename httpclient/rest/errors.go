...
// REST error helpers delegate to httpclient's error classification. These are convenience re-exports so REST client users don't need to import httpclient directly for error checking.
