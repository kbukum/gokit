...
// HostPort returns the host:port string (e.g., "192.168.1.5:8080"). Use this to set client Config.Addr from a discovered endpoint.
...
type Discovery interface {
	...
	// Watch returns a channel that emits the current set of instances whenever the service membership changes. Close the context to stop.
