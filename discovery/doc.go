...
//
// It defines interfaces and types for dynamically discovering healthy service instances from registries such as Consul or static configuration. The package follows gokit's component pattern with lifecycle management and health checks.
//
// # Architecture
//
