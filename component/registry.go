...
// lifecycleMu is already held by the caller (StartAll); no other Start/Stop can interleave.
...
// Otherwise a DefaultStopTimeout is applied as a bounded safety net.
