...
//
// It wraps [github.com/invopop/jsonschema] to produce standard JSON Schema 2020-12 documents from struct tags,
// and exposes the result as a plain map[string]any suitable for tool definitions, MCP,
// and LLM APIs.
//
// Usage:
//
...
//
// Values are validated against schemas with [Validate],
