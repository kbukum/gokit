...
// CanRead reports whether the current process can open path for reading. A
// permission-denied or not-found result yields false, not an error; any other
// failure is returned.
...
// CanWrite reports whether the current process can write to the file or
// directory at path. Directories are probed with a create-new temp file that is
// removed afterward. A permission-denied or not-found result yields false.
