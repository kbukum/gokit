...
Any package that reads or writes a config file, manifest, or document reuses these codecs
instead of re-implementing "bounded read → parse → typed error" per format.
