...
//
// In non-interactive mode it resolves to the recommended choice (a typed error when none is marked). Interactively it prints a numbered list and reads a one-based number; a blank answer accepts the default when present.
