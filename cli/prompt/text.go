...
//
// In non-interactive mode it resolves to the default (a typed error when absent or rejected by the validator).
...
// acceptText resolves a raw answer against the default and validator, returning the accepted value
// or a rejection reason to display before re-asking.
