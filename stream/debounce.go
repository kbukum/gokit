...
// Debounce waits for silence of the given duration after the last value before emitting.
// If a new value arrives during the quiet period, the timer resets
// and only the latest value is emitted.
//
