// Package middleware provides composable middleware for Kafka message handlers.
//
// Middleware wraps [kafka.MessageHandler] functions to add cross-cutting concerns
