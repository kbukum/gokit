...
// UnaryServerErrorInterceptor returns a unary server interceptor that converts
// AppError values returned by handlers into proper gRPC status errors, ensuring
// clients receive structured codes instead of codes.Unknown.
...
// Mirrors the inverse mapping in errors.go (FromGRPC) without creating a
// cross-package import cycle between interceptor ↔ root grpc package.
