...
func Example_customTestComponent() {
	...
	_ = func(c *MyTestComponent) error { return nil }                                       // Reset(ctx)
	_ = func(c *MyTestComponent) (interface{}, error) { return map[string]interface{}{}, nil } // Snapshot(ctx)
	_ = func(c *MyTestComponent) error { return nil }                                       // Restore(ctx, snapshot)
