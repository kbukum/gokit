...
//
// It uses Go generics so each project can store
// and retrieve its own claims type without gokit knowing about the specific fields.
//
// Usage:
//
...
// GetOrError retrieves typed claims from the context. Returns ErrNoClaims if claims are missing
