...
// UserInfo represents the standard OIDC UserInfo claims. Only standard fields are included —
// projects extract provider-specific claims by parsing the ID token
// or calling provider-specific APIs.
