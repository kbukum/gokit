...
//
// It includes a mock OAuth server that simulates the standard OAuth2 flow
// (authorization, token exchange, userinfo) and a MockProvider for unit testing
// code that depends on oidc.Provider without needing HTTP.
//
