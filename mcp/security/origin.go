...
// ValidateAllowedOrigin normalizes and rejects any Origin value that is not a bare scheme://host[:port] over http or https, failing closed on paths, queries, fragments, credentials, or opaque URLs.
