...
// Register wires the allowed tools, prompts, resources, and resource templates
// into the SDK server. Tools are filtered by the allow-list at registration
// time; prompts and resources are additionally gated at call time by their
// wrappers.
