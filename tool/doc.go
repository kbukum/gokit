// Package tool provides type-safe tool definitions, auto-wiring from typed functions,
// a concurrent-safe registry, and middleware composition.
//
...
// Destructive tools ([SafetyDestructive]) are always human-gated, and both the sensitivity
// and human-approval defaults deny,
