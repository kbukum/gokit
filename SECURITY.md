...
If you discover a security vulnerability in gokit, please report it **privately** using one of the following channels:

1. **Preferred**: [GitHub Security Advisories](https://github.com/kbukum/gokit/security/advisories/new) — opens a private disclosure thread visible only to maintainers.
2. **Alternative**: Email the maintainers (see [MAINTAINERS.md](MAINTAINERS.md)) with subject prefix `[SECURITY]`.
...
- **CVE assignment** for confirmed vulnerabilities affecting released versions, requested via GitHub Security Advisories.
