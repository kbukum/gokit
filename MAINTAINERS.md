...
gokit currently has a **single core maintainer**. This is a known sustainability risk for a project of this size (34 modules). We are actively looking for contributors interested in becoming co-maintainers, particularly in the following areas:
...
- Cut releases following the process documented in [docs/release-process.md](docs/release-process.md) (when present) or the `tag-modules.sh` workflow.
