...
This file lists the people responsible for the gokit project. Maintainers are
...
- A track record of high-quality contributions across multiple areas of the
  codebase.
- Familiarity with project conventions, the multi-module layout, and the
  release process.
...
- Cut releases following the process documented in
  [docs/release-process.md](docs/release-process.md) (when present) or the
  `tag-modules.sh` workflow.
