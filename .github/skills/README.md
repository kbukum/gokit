...
| [`parity`](parity/SKILL.md) | Align a capability with its sibling kit rskit — mirror whichever kit is strongest in that scope, keep gokit idiomatic Go, and track parity through rskit tracking issues. |
