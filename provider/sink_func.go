...
// ErrNilSinkFunc is returned by SinkFunc.Send when the wrapper was constructed
// with a nil function. Sends fail closed with this typed error rather than
// panicking on the runtime path.
...
// A nil fn is tolerated at construction; Send then fails closed with
// ErrNilSinkFunc instead of panicking.
