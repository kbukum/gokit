...
//
// Use it for explicit provider, adapter, dialect,
// or callable registration when the registered value is not itself a Provider.
// Provider implementations should use provider.Registry instead.
