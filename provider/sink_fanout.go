...
// FanOutSink creates a Sink that dispatches each input to multiple sinks in parallel. All sinks receive the same input concurrently. Errors from individual sinks are joined and returned together.
