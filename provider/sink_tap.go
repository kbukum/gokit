...
// TapSink wraps a Sink with a side-effect function that runs before sending. The tap function observes the input without modifying it. If the tap returns an error, the input is still forwarded to the inner sink.
//
