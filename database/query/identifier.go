...
// safeIdentifier matches a SQL identifier that is safe to interpolate into a query fragment: one
// or more segments of a letter/underscore followed by letters, digits, or underscores,
// joined by single dots (e.g. "name", "users.id", "public.users.created_at").
// Anything containing whitespace, quotes, or SQL metacharacters is rejected.
...
//
// Column and table names cannot be passed as bound parameters,
